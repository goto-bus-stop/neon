...
pub unsafe extern "C" fn new(env: Env, out: &mut Local, size: u32) -> bool {
    ...
    let status = (super::NAPI.napi_create_buffer)(env, size as usize, &mut bytes as *mut _, out as *mut _);
...
pub unsafe extern "C" fn data<'a, 'b>(env: Env, base_out: &'a mut *mut c_void, obj: Local) -> usize {
    let mut size = 0;
    assert_eq!(
        (super::NAPI.napi_get_buffer_info)(env, obj, base_out as *mut _, &mut size as *mut _),
